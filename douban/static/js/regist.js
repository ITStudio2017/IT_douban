...
//    var content=$(this).val();
//   if(content=="" && ($(".regist_form_code_again_input_tip").css('display') == 'none')){
//      // $(".input_code_tip").show();
//   }
...
// $("input").blur(function(){
//   if((name_wrong == true) && (code_wrong == true) )
// {
//   $(".regist_form_verify_button").attr('disabled','true');
//   $(".regist_form_verify_button").css('background-color','#C9C9C9')
...
// else{
//   $(".regist_form_verify_button").removeAttr('disabled');
//   $(".regist_form_verify_button").css('background-color','#02C39A')
// }

// })
// $(".regist_form_verify_button").click(function(){
//   if( name_wrong == false && code_wrong == false && empty_wrong == false)
//   {
//     $(".regist_form_verify_button").removeAttr('disabled')
//     window.location.href = "../html/login.html";
//   }
